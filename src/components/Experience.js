  ...
  return (
    <>
      <div className="max-w-[1250px] mx-auto  pb-10">
        ...
        <Card1 data={ExperienceData.cardData} value={'EX'} />
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 mt-10 px-4 ">
          ...
          <div className="transition duration-500 ease-in-out gap-3 uppercase font-semibold cursor-pointer font-[Haboro-Soft] text-sm md:text-[17px] px-6 py-3 rounded-full flex items-center bg-[#6eb43f] hover:bg-[#3c681e] text-white">
            <SiWhatsapp />
